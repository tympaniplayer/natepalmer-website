"""
Django settings for natepalmer_website project.
...
ROOT_URLCONF = "natepalmer_website.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "natepalmer_website.context_processors.extra_settings",
            ]
        },
    }
]

WSGI_APPLICATION = "natepalmer_website.wsgi.application"
